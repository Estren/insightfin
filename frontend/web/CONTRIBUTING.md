...
## How to Contribute
- **Report Issues:** Found a bug or have a suggestion? Feel free to [open an issue](https://github.com/Estren/insightfin/issues).
- **Submit Enhancements:** If you have an idea for improving the project, please [open an issue](https://github.com/Estren/insightfin/issues) to discuss it before implementing changes.
